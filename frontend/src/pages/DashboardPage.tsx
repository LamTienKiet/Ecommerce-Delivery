export const DashboardPage = () => {
  // Mock data cho danh sách đơn hàng gần đây
  const recentOrders = [
    {
      id: "#1024",
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Chào mừng quay lại, Chef! Đây là báo cáo hiệu suất hoạt động hôm nay.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-400">Doanh Thu Ngày</span>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-400">Đơn Hàng Mới</span>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-400">Món Ăn Hoạt Động</span>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow duration-200 flex flex-col justify-between">
          <div className="flex items-center justify-between">
            <span className="text-sm font-semibold text-slate-400">Khách Hàng Mới</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-bold text-slate-900 text-lg">Biểu Đồ Doanh Thu Tuần</h3>
              <p className="text-xs text-slate-400 mt-0.5">Xu hướng từ Thứ 2 đến Chủ nhật</p>
            </div>
          ...
          <div className="h-60 flex flex-col justify-between">
            ...
            <div className="flex-1 flex items-end justify-between px-4 pb-2 relative h-48 border-b border-slate-100">
              ...
              <div className="flex flex-col items-center flex-1 space-y-2 group">
                <div className="w-10 bg-indigo-100 group-hover:bg-indigo-600 rounded-t-lg transition-all duration-300 relative" style={{ height: "45px" }}>
              ...
              {/* T3 */}
              <div className="flex flex-col items-center flex-1 space-y-2 group">
                <div className="w-10 bg-indigo-100 group-hover:bg-indigo-600 rounded-t-lg transition-all duration-300 relative" style={{ height: "70px" }}>
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
                    2.0M
                  </span>
                </div>
              ...
              {/* T4 */}
              <div className="flex flex-col items-center flex-1 space-y-2 group">
                <div className="w-10 bg-indigo-600 rounded-t-lg transition-all duration-300 relative" style={{ height: "135px" }}>
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
                    4.28M (Hôm nay)
                  </span>
                </div>
              ...
              {/* T5 */}
              <div className="flex flex-col items-center flex-1 space-y-2 group">
                <div className="w-10 bg-indigo-100 group-hover:bg-indigo-600 rounded-t-lg transition-all duration-300 relative" style={{ height: "90px" }}>
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
                    2.8M
                  </span>
                </div>
              ...
              {/* T6 */}
              <div className="flex flex-col items-center flex-1 space-y-2 group">
                <div className="w-10 bg-indigo-100 group-hover:bg-indigo-600 rounded-t-lg transition-all duration-300 relative" style={{ height: "110px" }}>
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
                    3.5M
                  </span>
                </div>
              ...
              {/* T7 */}
              <div className="flex flex-col items-center flex-1 space-y-2 group">
                <div className="w-10 bg-indigo-100 group-hover:bg-indigo-600 rounded-t-lg transition-all duration-300 relative" style={{ height: "145px" }}>
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
                    4.8M
                  </span>
                </div>
              ...
              {/* CN */}
              <div className="flex flex-col items-center flex-1 space-y-2 group">
                <div className="w-10 bg-indigo-100 group-hover:bg-indigo-600 rounded-t-lg transition-all duration-300 relative" style={{ height: "160px" }}>
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] py-1 px-1.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-md pointer-events-none">
                    5.2M
                  </span>
                </div>
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm flex flex-col justify-between">
          <div>
            <h3 className="font-bold text-slate-900 text-lg">Trạng Thái Đơn Hàng</h3>
            <p className="text-xs text-slate-400 mt-0.5">Phân chia đơn hàng hôm nay</p>
          </div>
          ...
          <div className="py-6 flex items-center justify-center relative">
            ...
            <svg className="w-36 h-36" viewBox="0 0 36 36">
              ...
              {/* Completed - 60% (Green) */}
              <circle cx="18" cy="18" r="15.915" fill="none" stroke="#10b981" strokeWidth="4.2" strokeDasharray="60 40" strokeDashoffset="25" />
              {/* Delivering - 25% (Purple) */}
              <circle cx="18" cy="18" r="15.915" fill="none" stroke="#8b5cf6" strokeWidth="4.2" strokeDasharray="25 75" strokeDashoffset="-35" />
              {/* Pending - 15% (Amber) */}
              <circle cx="18" cy="18" r="15.915" fill="none" stroke="#f59e0b" strokeWidth="4.2" strokeDasharray="15 85" strokeDashoffset="-60" />
            </svg>
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        <div className="px-6 py-5 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-0.5">Danh sách các đơn hàng mới nhất trên hệ thống</p>
          </div>
            ...
            <tbody className="divide-y divide-slate-100 text-sm text-slate-600">
              {recentOrders.map((order) => (
                <tr key={order.id} className="hover:bg-slate-50/40 transition-colors">
                  ...
                  <td className="px-6 py-4 font-bold text-indigo-600">{order.amount}</td>
                  <td className="px-6 py-4 text-xs text-slate-400">{order.time}</td>
                  <td className="px-6 py-4">{getStatusBadge(order.status, order.statusLabel)}</td>
