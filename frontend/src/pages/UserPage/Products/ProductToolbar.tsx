    ...
    <div className="border border-[#2a3c31] bg-[#16251e] rounded-2xl p-6 flex flex-col md:flex-row items-center gap-4 justify-between shadow-xl">
      ...
      <div className="relative w-full md:flex-1 min-w-[280px]">
        <span className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
          <svg className="w-5 h-5 text-[#A9B4A4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
        {/* Category Dropdown (Mobile fallback/alternative) */}
        <div className="flex-1 md:flex-initial">
          ...
          >
            ...
            <option value="1">Khai vị (Appetizer)</option>
            <option value="2">Món chính (Main Course)</option>
            <option value="3">Tráng miệng (Dessert)</option>
            <option value="4">Đồ uống (Beverage)</option>
          </select>
        </div>
